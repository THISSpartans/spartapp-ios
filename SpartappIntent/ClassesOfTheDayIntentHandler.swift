//
//  ClassesOfTheDayIntentHandler.swift
//  SpartappIntent
//
...
class ClassesOfTheDayIntentHandler: NSObject, ClassesOfTheDayIntentHandling {
    
    var day = 0
    
    func confirm(intent: ClassesOfTheDayIntent, completion: @escaping (ClassesOfTheDayIntentResponse) -> Void) {
        day = returnDay()
        if day == -1{
            completion(ClassesOfTheDayIntentResponse(code: .noClass, userActivity: nil))
        }else{
            print(day)
            completion(ClassesOfTheDayIntentResponse(code: .success, userActivity: nil))
        }
        
        
    }
    
    func handle(intent: ClassesOfTheDayIntent, completion: @escaping (ClassesOfTheDayIntentResponse) -> Void) {
        ...
        if day != -1{
            ...
            completion(ClassesOfTheDayIntentResponse.success(classes: response))
        }
